...
const escapeHTML = require('@f0c1s/escape-html')
const escapeJS = require('@f0c1s/escape-javascript')
...
let names = ['rot47', 'base64.encode', 'base64.decode', 'escapeJS.escape', 'escapeHTML.escape']
let fns = [rot47, base64.encode, base64.decode, escapeJS.escape, escapeHTML.escape]
let out = fns.map(fn => {
    let val = ''
    try {
        val = fn(input)
